...
export const TransmittalModal: React.FC<TransmittalModalProps> = ({ project, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      <div className="w-full max-w-4xl bg-[#18181b] border border-indigo-500/50 rounded-sm shadow-[0_0_60px_rgba(0,0,0,0.8)] flex flex-col overflow-hidden relative h-[85vh]">
        ...
        <div className="flex flex-1 overflow-hidden">
            {/* Left: Controls */}
            <div className="w-1/3 bg-[#09090b] border-r border-white/10 p-6 flex flex-col gap-5 overflow-y-auto custom-scrollbar">
                ...
                <div className="space-y-1.5">
                    ...
                    <select 
                        ...
                        className="w-full p-2.5 bg-[#18181b] border border-white/10 rounded text-sm text-white focus:outline-none focus:border-indigo-500"
                    >
                ...
                <div className="space-y-1.5 flex-1 flex flex-col">
                    ...
                    <textarea 
                        ...
                        className="w-full flex-1 p-2.5 bg-[#18181b] border border-white/10 rounded text-sm text-white focus:outline-none focus:border-indigo-500 resize-none"
                    />
                </div>
                ...
                <button 
                    ...
                    className="w-full py-3 bg-indigo-600 hover:bg-indigo-500 disabled:bg-neutral-800 disabled:text-neutral-500 text-white rounded font-bold uppercase text-xs tracking-wider flex items-center justify-center gap-2 transition-all shadow-lg"
                >
            ...
            <div className="flex-1 bg-[#121212] flex flex-col relative">
                {generatedText ? (
                    <>
                        ...
                        <div className="p-4 bg-[#18181b] border-t border-white/10 flex justify-end gap-3 z-20">
